...
var btnGetMessages = document.querySelector("#btnGetMessages");
...
connection.on("messageReceived", function (username, datatime, message) {
...
function GetMessages() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getResource("Message/GetAll")];
                case 1:
                    data = _a.sent();
                    messages.textContent = data
                        .map(function (msg) { return msg.dateTime + " - user=" + msg.user + " said - " + msg.text; })
                        .join("\n\r");
                    return [2 /*return*/];
            }
        });
...
btnGetMessages.addEventListener("click", function () {
    GetMessages();
}, false);
